...
To answer the research questions, different filtering and preparation steps were applied to each dataset:
...
Our analysis reveals clear relationships between the rapid growth of large language models and trends in the AI job market. The sharp increase in LLM releases between 2021 and 2023 aligns closely with the surge in AI job postings between 2022 and 2024. This pattern suggests that advancements in AI technology, particularly the release of new foundation models, are associated with rising workforce demand. While we cannot claim direct causality, the timing strongly indicates that the expansion of model capabilities drives companies to hire more engineers, analysts, and researchers who can apply, integrate, or maintain these systems.

Across companies, we found that the organizations releasing the largest models are not necessarily the ones releasing the most. Meta AI consistently produced the biggest models on average, while Google, Microsoft, and Meta led in total number of releases. This indicates that companies differ in strategic emphasis: some prioritize innovation through scale, while others prioritize iteration and volume. These differences reflect broader industry approaches to competitiveness in AI development.

Salary trends further highlight how the job market responds to technical shifts. Machine Learning Engineers and AI Engineers consistently earned the highest salaries from 2020 to 2025, especially after 2022, when interest in large model deployment increased. Data Scientists and Data Analysts also experienced salary growth, but their increases were more moderate. This suggests that roles closest to model architecture, optimization, and application command the strongest compensation as organizations accelerate adoption of AI systems.

Finally, our cross country analysis demonstrates that geographic factors strongly influence salary outcomes. Even when job titles are held constant, the United States maintains a significant salary advantage, followed by Mexico and Canada. This variation suggests that local economic conditions, labor markets, and industry presence shape compensation more heavily than job title alone.
